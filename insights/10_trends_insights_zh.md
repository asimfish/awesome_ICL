...
> 写作时间：2026-08-31（09-01 增补 S1 与四篇 EICL 论文；09-02 增补 EICL 直系 6 项 + 理论与谱系专题；09-02 晚由 5 路子 agent 并行补齐历史源头、底座、动作头、数据管线、同代对照 13 项；09-03 补齐潜动作、上下文 RL 前史、人类共训、基准地基、具身安全 19 项，并据此修正预测 P5；09-04 补齐几何编码、规划层 ICL、检索与技能库 9 项；09-05 补齐视觉 ICL 前史、开源高效 VLA、适应旋钮两端 8 项；09-06 增补 Zeva 与后训练干扰两篇）
...
- **自我改进的公平基线**：Zeva 式「越用越稳」需与无记忆独立重试的 CSR@K 曲线并排，并与 RoboTTT 快权重记忆、ConRFT 一小时 RL 做成本-收益对照（notes/40、39）。
