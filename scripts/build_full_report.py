...
PARTS = [
 ("0", "执行摘要：趋势与洞察", "六大趋势 · 十三条洞察 · 七条可证伪预测 · 开放问题——全部结论先行，细节见后续各章。",
  [repo/"insights/10_trends_insights_zh.md"]),
